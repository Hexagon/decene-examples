...
function setTitle(status, uuid, connectivity, glob, globTot) {
    //52
    //202
    //22
    textTop.setText("  " + package.name + " " + package.version + " - status: " + status + " - connection: " + connectivity + " - alive nodes: " + glob + "/" +globTot);
    screen.render();
}
